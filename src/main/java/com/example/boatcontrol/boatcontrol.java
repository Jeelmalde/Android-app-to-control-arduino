...
public class boatcontrol extends AppCompatActivity {
    ...
    static final UUID myUUID = UUID.fromString("243b9f78-3265-11ea-850d-2e728ce88125");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boatcontrol);
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(boatcontrol.this, "Connecting...", "Please wait!!!");  //show a progress dialog
        }
